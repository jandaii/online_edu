...
<html class="no-js">
    <head>
        <jsp:useBean id="Bean_student" class="mybean.data.Bean_student" scope="application"/>
    ...
    <body>
        ...
        <div class="about_con">
            <div class="wrap">
                <div class="left">
                    <ul class="s_list">
                        <li><a href="Guanli_zhanghao.jsp" class="curr">学生账户管理</a></li>
                        <li><a href="Guanli_jiaoshiguanli.jsp">教师账户管理</a></li>
                    </ul>
                </div>
                <div align="center">
                    ...
                    <form action="Servlet_student_add" method="post" name="addbanji">
                        <table><tr><td><h3>请输入新学生名称：
                                        <input type="text" name="s_name" id="file_input" /> <p></td></tr>
                                        <tr><td><h3>请输入新学生学号：
                                                    <input type="text" name="s_no" id="file_iut" /> <p></td></tr>
                                                        <input type ='hidden' name='college' value=<%=college%>>
                                                        <input type ='hidden' name='major' value=<%=major%>>
                                                        <input type ='hidden' name='Class_name' value=<%=Class_name%>>
                                                    <tr><td><input type="submit" value="添加学生账户" >
                                                            </form></td></tr></table>
                                                    <jsp:getProperty name="Bean_student"  property="backNews" /> </div>
