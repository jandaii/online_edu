                ...
                <form action="Servlet_gonggao_change" method="post" name="xinxi">
                    ...
                    <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;请修改信息类型：
                        <select name="leixin" size="1" style= "height:30px;width:100px">
                            ...
                            <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请修改信息标题：<INPUT type="text" name="biaoti" value=<%=title%> style= "height:30px;width:200px;"><p></td></tr>
                                <tr><td><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请修改信息内容：<p>
                                            <div align="center"><TEXTAREA name="neirong" rows="20" cols="80"><%=content%></TEXTAREA><P><p></td></tr></table>
                        <input type="submit" name="xinxi" value="修改" style= "height:30px;width:80px;color:#0000FF"></div>
                </form>
