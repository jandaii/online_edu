...
.ss_ban{ width:100%;height:466px; overflow:hidden;}
  ...
  <tr>
    ...
    <td class="myTitle"><font color = "#9370D8">完成作业人数</font></td>
    <td class="myTitle"><font color = "#9370D8">作业满分</font></td>
    <td class="myTitle"><font color = "#9370D8">平均分</font></td>
      ...
      if(totalPages>=1) {
         ...
         for(int i=1;i<=pageSize&&boo;i++) { 
            String hw_name=rowSet.getString(3);
             String count=rowSet.getString(7);
             String sum=rowSet.getString(6);
            String avg=rowSet.getString(8);
           ...
           //hw = hw.replaceAll("\\p{Blank}","");
            ...
            String detail="<form  action='proportion.jsp' method = 'post'>"+
                     "<input type ='hidden' name='taskname' value= "+hw_name+">"+
