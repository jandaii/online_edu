...
<jsp:useBean id="userBean4" class="mybean.data.Addwork_judge" scope="session"/>
...
th,td { border: solid 1px #F2F3F5; text-align: center; }
  	...
  	<form action="Addwork_judgeServlet" method="post">
  	<input type="hidden" name="quesType" value="判断题">
  	...
  	<table  class="myTable"  width="100%" frame="border" border="0" cellspacing="0" cellpadding="0">
  		...
  		<tr>
  			...
  			<td><input type="radio" name="quesanswer" value="true">√&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
  				<input type="radio" name="quesanswer" value="false">×</td>
  		</tr>
  		<tr>
  		...
  		<tr>
  			...
  			<td >×</td>
                ...
                <div align="center">
<p> 反馈：
<jsp:getProperty name="userBean4"  property="backNews" /> 
