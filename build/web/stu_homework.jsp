...
%> 
              <li><a href="stu_score.jsp?course_name=<%=course_name%>">查看成绩</a></li></ul>	
...
th,td { border: solid 1px #F2F3F5; text-align: center; }
    ...
    try {       
       ...
       if(dateStart.compareTo(str_date1)<0&&dateEnd.compareTo(str_date1)>0){
              %>
            <tr>
                <td><li><a href="stu_homework_1.jsp?task_id=<%=task_id%>&task_name=<%=task_name%>"><%=task_name%></a></li></td></tr>
              <%
       }
       else if(dateEnd.compareTo(str_date1)<0){
           %>
       
                <tr>
                    <td><li><span style="color: red"><%=task_name%>已过期</span></li></td></tr>
         <% }
       else{
       }
