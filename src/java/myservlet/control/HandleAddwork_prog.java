...
public class HandleAddwork_prog extends HttpServlet{
   ...
   {   try{ byte bb[]=s.getBytes("iso-8859-1");
    ...
    public  void  doPost(HttpServletRequest request,HttpServletResponse response) 
     ...
     String uri="jdbc:mysql://rm-2vcwo56w973ev4a09pm.mysql.cn-chengdu.rds.aliyuncs.com:3306/work?user=work&password=swufework&useUnicode=true&characterEncoding=gb2312" ;
      ...
      Addwork_prog userBean6=new Addwork_prog();  //创建的Javabean模型
      request.setAttribute("userBean6",userBean6);
      ...
      try{   con=DriverManager.getConnection(uri);
             ...
             { 
               ...
               if(m!=0){
                  backNews="添加成功";
                  userBean6.setBackNews(backNews);
                  userBean6.setQuesname(quesname);
                  userBean6.setQuescontent(handleString(quescontent));
                  userBean6.setQuesType(handleString(quesType));
                  userBean6.setQuesscore(handleString(quesscore));
                   userBean6.setQuesanswer(handleString(quesanswer));
                    userBean6.setHw_name(hw_name);
               }
            }
             else {
      ...
      request.getRequestDispatcher("ques_prog.jsp");
