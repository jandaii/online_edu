...
<html class="no-js">
    <head>
        <jsp:useBean id="dataBean" class="mybean.data.Bean_xinxibypage" scope="session"/>
    ...
    <body>
        ...
        <div class="about_con">
            <div class="wrap">
                <div class="left">
                    <ul class="s_list">
                        <li><a href="Servlet_gonggao?a=2" class="curr">通知公告</a></li>
                        ...
                        <%
                            ...
                            if (totalPages >= 1) {
                                ...
                                for (int i = 1; i <= pageSize && boo; i++) {
                                    ...
                                    String detail = "<form  action='Gonggao_details.jsp' method = 'post' maxPostSize='0'>"
