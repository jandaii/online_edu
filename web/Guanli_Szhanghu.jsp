    ...
    <body>
        ...
        <div class="about_con">
            <div class="wrap">
                ...
                <div align="center">
                    <form action="Guanli_Szhanghu_chaxun.jsp" method="post" name="myform">
                        <table><tr><td>
                                    <h3>请选择学生所属学院：
                                        ...
                                        <tr><td><h3>请选择学生所属专业：
                                                    <select name="major" onChange="changelocation2(document.myform.xueyuan.options[document.myform.xueyuan.selectedIndex].value, document.myform.major.options[document.myform.major.selectedIndex].value)" size="1" style= "height:30px;width:180px"><p></td></tr>
                                                        ...
                                                        <tr><td><h3>请选择学生班级：
                                                                    ...
                                                                    <tr><td> <input type="submit" value="查询学生账户" ></td></tr></table>
                                                                    </form>
                                                                    <jsp:getProperty name="Bean_student"  property="backNews" /> 
                                                            <div class="footer">
	<div class="wrap">
		<div class="f_pad">
			<div class="fl">
