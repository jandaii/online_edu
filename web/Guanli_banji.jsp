...
<html class="no-js">
    <head>
         <jsp:useBean id="Bean_banji" class="mybean.data.Bean_banji" scope="application"/>
    ...
    <body>
        ...
        <div class="about_con">
            <div class="wrap">
                <div class="left">
                    <ul class="s_list">
                        <li><a href="Guanli_banji.jsp" class="curr">建立班级</a></li>
                        <li><a href="Guanli_banjiguanli.jsp">查询班级</a></li>
                        <li><a href="Guanli_banjiguanli.jsp">修改班级</a></li>
                        <li><a href="Guanli_banjiguanli.jsp">删除班级</a></li>
                    </ul>
                ...
                <div align="center">
                      <form action="Servlet_banji" method="post" name="addbanji">
                          <table><tr><td>
         <h3>请选择班级所属学院：
                       <input type="text" name="xueyuan" id="file_input" /> <p></td></tr>
                           
                       <tr><td>
                              <h3>请选择班级所属专业：
                                  <input type="text" name="zhuanye" id="file_input" /> <p></td></tr>
                                  <tr><td><h3>请输入班级名称：
                                              <input type="text" name="banjix" id="file_input" /> <p></td></tr>
                                              <tr><td><input type="submit" value="添加班级"></form></td><td> </table>
      
                <jsp:getProperty name="Bean_banji"  property="backNews" /> </div>
                <div class="clear"></div>
            </div>
        </div>
      <div class="footer">
