    ...
    <body>
        ...
        <div class="wrap">
            <div align="center" >
                ...
                <form action="Servlet_banji_change" method="post" name="xnxi">
                    ...
                    <%request.setCharacterEncoding("gb2312");
                        ...
                        String Class_id = request.getParameter("id").trim();
                    %>
                    <table><tr><td><h3>请修改班级所属学院：
                                    <input type="text" name="college" value=<%=college%> id="file_input" /> <p></td></tr>
                                    <tr><td><h3>请修改班级所属专业：
                                                <input type="text" name="major" value=<%=major%> id="file_inut" /> <p></td></tr>
                                                <tr><td><h3>请修改班级号：
                                                            <input type="text" name="Class_name" value=<%=Class_name%> id="file_inut" /> <p></td></tr>
                                                          
                                                                <input type="hidden" name="Class_id" value=<%=Class_id%> id="file_iut" />
                                                                       

                                                                        <tr><td><input type="submit" value="修改班级信息" >
