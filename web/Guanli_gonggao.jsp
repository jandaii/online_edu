...
<html class="no-js">
    <head>
        <jsp:useBean id="dataBean" class="mybean.data.Bean_xinxibypage" scope="request"/>
    ...
    <body>
        ...
        <div class="about_con">
            <div class="wrap">
                <div class="left">
                    <ul class="s_list">
                        <li><a href="Servlet_gonggao?a=1" class="curr">通知公告</a></li>
                        <li><a href="Servlet_gonggao2?a=1">学校新闻</a></li>
                        <li><a href="Servlet_gonggao3?a=1">学术讲座</a></li>
                        <li><a href="Servlet_gonggao4?a=1">前沿动态</a></li>
                    </ul>
                </div>
                <div class="right">
                    <h1 class="a_tit">【通知公告】</h1>
                    <p style="line-height:2.6em;font-size:16px;">
                        <Table align=center><tr><td>
                        <jsp:getProperty name="dataBean"  property="backNews" /> 
                        ...
                        <%
                            ...
                            if (totalPages >= 1) {
                                ...
                                for (int i = 1; i <= pageSize && boo; i++) {
                                    ...
                                    String detail = "<form  action='Guanli_gonggao_details.jsp' method = 'post' maxPostSize='0'>"
                                            + "<input type ='hidden' name='id' value= " + id + ">"
                                            + "<input type ='hidden' name='title' value= " + title + ">"
                                            + "<input type ='hidden' name='type' value='通知公告'>"
