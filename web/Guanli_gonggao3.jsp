...
<html class="no-js">
    <head>
        <jsp:useBean id="dataBean3" class="mybean.data.Bean_xinxibypage3" scope="request"/>
            ...
            <div class="wrap">
                <div class="left">
                    <ul class="s_list">
                        ...
                        <li><a href="Servlet_gonggao3?a=1" class="curr">学术讲座</a></li>
                        <li><a href="Servlet_gonggao4?a=1">前沿动态</a></li>
                    </ul>
                </div>
                <div class="right">
                    <center>
			<h1 class="a_tit">【学术讲座】</h1>
...
<%    
      ...
      int pageSize=dataBean3.getPageSize();  //每页显示的记录数
         ...
         for(int i=1;i<=pageSize&&boo;i++) {  
            ...
            session.setAttribute("content",content); 
             String detail="<form  action='Guanli_gonggao_details.jsp' method = 'post'>"+
                     ...
                     "<input type ='hidden' name='type' value='学术讲座'>"+
...
%></td></tr>
                                 <tr><td>
 <BR>每页最多显示<jsp:getProperty name="dataBean3" property="pageSize"/>条信息
