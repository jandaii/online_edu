...
<jsp:useBean id="loginBean3" class="mybean.data.L_Administerlogin" scope="session"/>
...
<div class="about_con">
	...
	<div class="wrap">
            <div class="left">
			<ul class="s_list">
				<li><a href="L_Alogin.jsp" class="curr">管理员登录</a></li>
			</ul>
		</div>
		<div class="right">
			<h1 class="a_tit">管理员登录系统</h1>
			<div class="r_text">

          <center>
              	<form action="L_ALoginServlet" method="post" name="form">
<table  margin="auto" height="auto" width="auto" >
<tr><td><font color = "#800080">账号：<Input type=text name="Administer_No"></td></tr>
<tr><td><font color = "#800080">密码：<Input type=password name="Administer_password"></td></tr>
 <tr>
...
<div align="center" >
 登录反馈：<jsp:getProperty name ="loginBean3" property="backNews"/>
