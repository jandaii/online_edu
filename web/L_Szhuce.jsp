...
<jsp:useBean id="userBean" class="mybean.data.L_Student" scope="session"/>
<!DOCTYPE html>
<html class="no-js">
<head>
<meta charset="gb2312" />
...
<div class="about_con">
	<div class="wrap">
            <div class="left">
			<ul class="s_list">
				<li><a href="L_Slogin.jsp" >学生登录</a></li>
				<li><a href="L_Szhuce.jsp" class="curr">学生注册</a></li>
			</ul>
		</div>
		<div class="right">
			<h1 class="a_tit">学生注册系统</h1>
			<div class="r_text">
 

    <center>
	<form action = "L_SRegisterServlet" method = "post" >
  	<table  margin="auto" height="auto" width="auto" >
  	  <tr>
		<th>学号：</th>
		<td><input type="text" name="Student_No" maxlength = "10" ></td>
                <td><font color = "#006000"><h5>请输入学号，不超过10个字符。</h5></td>
                
 	  </tr>
            <tr>
		<th>姓名：</th>
		<td><input type="text" name="Student_name" maxlength = "10" ></td>
	  ...
	  <tr>
 		<th>班级：</th>
 		<td><input type="text" name="Class_id"  maxlength = "15" ></td>
                <td><font color = "#006000"><h5>请输入班级，不超过15个字符。</h5></td>
 	  </tr> 
 ...
 <tr>
     <td>
         <h5><a href="L_Slogin.jsp">立即登录</a></h5>
     </td>
 </tr>
        </table>
    </form>
