...
<div class="about_con">
	...
	<div class="wrap">
            <div class="left">
			<ul class="s_list">
				<li><a href="L_Tlogin.jsp" class="curr">教师登录</a></li>
				<li><a href="L_Tzhuce.jsp">教师注册</a></li>
			</ul>
		</div>
		<div class="right">
			<h1 class="a_tit">教师登录系统</h1>
			<div class="r_text">
          <center>
              <form action="L_TLoginServlet" method="post" name="form">
<table  margin="auto" height="auto" width="auto" >
<tr><td>学工号：<Input type=text name="Teacher_No"></td></tr>
<tr><td>密码：<Input type=password name="Teacher_password"></td></tr>
 <tr>
  <td colspan="2" align="center"> <input type="submit"name="submit"value="登录">
   &nbsp; <input type="submit"name="submit2"value="取消"></td>
     ...
     <tr>
     <td>
         <h5><a href="L_Tzhuce.jsp">没有账号?立即注册</a></h5>
     </td>
 </tr>
...
<div align="center" >
 登录反馈：<jsp:getProperty name ="loginBean2" property="backNews"/>
