...
<jsp:useBean id="userBean5" class="mybean.data.Addwork_ansRel" scope="session"/>
...
th,td { border: solid 1px #F2F3F5; text-align: center; }
  	...
  	<form action="Addwork_ansRel" method="post">
  	<input type="hidden" name="quesType" value="问答题">
  	...
  	<table  class="myTable" width="100%" frame="border" border="0" cellspacing="0" cellpadding="0">
        ...
        <div align="center">
<p> 反馈：
<jsp:getProperty name="userBean5"  property="backNews" /> 
